        ...
        <div className="music-panel" ref={panelRef}>
          ...
          <div className="music-embed">
            <div className="music-playlist-card">
              <div className="music-wave-art">
                <span className="wave-dot w1" />
                <span className="wave-dot w2" />
                <span className="wave-dot w3" />
                <span className="wave-dot w4" />
                <span className="wave-dot w5" />
                <span className="music-note">🎶</span>
              </div>
              <p className="music-playlist-title">我的歌单</p>
              <p className="music-playlist-hint">点击下方按钮在网易云中播放</p>
              <a
